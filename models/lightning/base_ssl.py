...
class BaseSSL(L.LightningModule):
    def __init__(
        self,
        save_folder: str,
        vit_model: nn.Module,
    ...
    def training_step(self, batch: Any, batch_idx: int) -> torch.Tensor:
        ...
        total_loss = (self.weight_ssl * sslconloss) + (self.weight_supcon * supconloss)
    ...
    def validation_step(self, batch: Any, batch_idx: int) -> torch.Tensor:
        ...
        if self.global_rank == 0 and batch_idx % 5 == 0:
            ...
            if enc_outputs.pool_attn is not None:
                attn = enc_outputs.pool_attn[:, :, 1:].reshape(b, -1, h_feat, w_feat)
